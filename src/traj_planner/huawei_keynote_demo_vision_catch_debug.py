...
if __name__ == "__main__":
    ...
    pose: 
        position: 
        x: 0.12287303149343812
        y: 0.5360814354408133
        z: 0.35301754191112417
    orientation: 
        x: 0.2958384073800003
        y: -0.8127103399893119
        z: 0.17179625334338194
        w: 0.4716646979905307
    """
    print("=========== moveit 执行位0位 到 执行位3位 开始规划====================")
    new_target_pose_stamped = PoseStamped()
    new_target_pose_stamped.header.frame_id = "torso"
    new_target_pose_stamped.pose.position.x = 0.12287303149343812
    new_target_pose_stamped.pose.position.y = 0.5360814354408133
    new_target_pose_stamped.pose.position.z = 0.35301754191112417

    # 修改成斜着抓
    new_target_pose_stamped.pose.orientation.x = 0.2958384073800003
    new_target_pose_stamped.pose.orientation.y = -0.8127103399893119
    new_target_pose_stamped.pose.orientation.z = 0.17179625334338194
    new_target_pose_stamped.pose.orientation.w = 0.4716646979905307

    planner.set_start_state(Point_zero)
    traj = planner.plan_to_target_pose(new_target_pose_stamped)
    ...
    pose: 
        position: 
        x: 0.2408206420805181
        y: 0.2547058685103139
        z: 0.1286305085284178
    orientation: 
        x: -0.0005415117928390053
        y: -0.7904067783434578
        z: 0.0003267500100802998
        w: 0.6125820147116018
    """
    print("=========== moveit 执行位3位 到 执行位5位 开始规划====================")
    new_target_pose_stamped = PoseStamped()
    new_target_pose_stamped.header.frame_id = "torso"
    new_target_pose_stamped.pose.position.x = 0.2408206420805181
    new_target_pose_stamped.pose.position.y = 0.2547058685103139
    new_target_pose_stamped.pose.position.z = 0.1286305085284178

    # 修改成斜着抓
    new_target_pose_stamped.pose.orientation.x = -0.0005415117928390053
    new_target_pose_stamped.pose.orientation.y = -0.7904067783434578
    new_target_pose_stamped.pose.orientation.z = 0.0003267500100802998
    new_target_pose_stamped.pose.orientation.w = 0.6125820147116018
