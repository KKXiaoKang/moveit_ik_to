...
from utils import load_traj, dump_traj, load_joints
...
class Planner(Base):
    ...
    def __init__(self) -> None:
        ...
        super(Planner, self).init_move_group()
        self.optimizer = Optimizer(self.robot, self.l_move_group, self.r_move_group)
    ...
    def set_pick_config(self, pose: geometry_msgs.msg.Pose) -> moveit_msgs.msg.Grasp:
        ...
        grasp.pre_grasp_approach.desired_distance = 0.04
        
        grasp.post_grasp_retreat.direction.vector = -1
        grasp.post_grasp_retreat.min_distance = 0.02
        grasp.post_grasp_retreat.desired_distance = 0.04
    ...
    def set_place_config(self, pose: geometry_msgs.msg.Pose) -> moveit_msgs.msg.PlaceLocation:
        ...
        place.pre_place_approach.direction.vector = 1
        place.pre_place_approach.min_distance = 0.02
        place.pre_place_approach.desired_distance = 0.04
