...
def set_robot_arm_wave(kuavo_robot, publisher):
    """
       机器人回到初始状态
    """
    r_traj = load_traj("./traj/home/traj_r_home1.json")
    publish_r_arm_traj(publisher, r_traj)

    r_traj = load_traj("./traj/home/traj_r_home2.json")
    publish_r_arm_traj(publisher, r_traj)

    r_traj = load_traj("./traj/home/traj_r_home3.json")
    publish_r_arm_traj(publisher, r_traj)
...
def robot_arm_action(kuavo_robot, action_name:str)->bool:
    ...
    if action_name == "bowing":
        ...
        return True
    elif action_name == "wave_arm":
        # 执行送花动作
        set_robot_arm_wave(kuavo_robot, robot_arm_publisher)
        return True
    else:
        # 未知动作
